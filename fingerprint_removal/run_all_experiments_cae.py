...
bat_file = open('run_all_experiments_cae.bat','w')
for s in subexp:

    original_dataset_dir = 'F:\\gan_fingerprint_removal\\data\\' + s

    out_path = 'real2fake_cae{0}_{1}_{2}'.format(latent_code_size, cae_epochs, s)
    command = "python transform_dataset_cae.py {0} {1} {2} {3}".format(cae_epochs,
    ...
    data_dir = 'real2fake_cae{0}_{1}_{2}'.format(latent_code_size, cae_epochs, s)
